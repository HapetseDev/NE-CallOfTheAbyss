...
const NORMAL_ATTACK := preload("res://src/resources/abilities/normal_attack.tres")
const RUN_SKILL := preload("res://src/resources/abilities/run.tres")
const HEAL_SKILL := preload("res://src/resources/abilities/heal.tres")
