...
##
## Run (terminal):
##   Godot --headless --path . --script res://src/debug/tools/bake_meshlibrary_collisions.gd
##
## Or in the Godot editor: open this script → File → Run.

const LIBRARY_PATH := "res://assets/tilesets/tilesfreedungeon.tres"
const MIRROR_MESHLIB_PATH := "res://assets/tilesets/tilesfreedungeon.meshlib"
